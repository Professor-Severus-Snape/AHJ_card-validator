...
;// CONCATENATED MODULE: ./src/licenses/licenses.txt
...
const card_mastercard_namespaceObject = __webpack_require__.p + "img/card-mastercard.svg";
;// CONCATENATED MODULE: ./src/img/card-americanExpress.svg
const card_americanExpress_namespaceObject = __webpack_require__.p + "img/card-americanExpress.svg";
;// CONCATENATED MODULE: ./src/img/card-discoverCard.svg
const card_discoverCard_namespaceObject = __webpack_require__.p + "img/card-discoverCard.svg";
;// CONCATENATED MODULE: ./src/img/card-jcb.png
const card_jcb_namespaceObject = __webpack_require__.p + "img/card-jcb.png";
;// CONCATENATED MODULE: ./src/img/card-dinersClub.svg
...
function Copyrights_classCallCheck(a, n) { if (!(a instanceof n)) throw new TypeError("Cannot call a class as a function"); }
function Copyrights_defineProperties(e, r) { for (var t = 0; t < r.length; t++) { var o = r[t]; o.enumerable = o.enumerable || !1, o.configurable = !0, "value" in o && (o.writable = !0), Object.defineProperty(e, Copyrights_toPropertyKey(o.key), o); } }
...
var Copyrights = /*#__PURE__*/function () {
  ...
  // </address>
  function Copyrights() {
    Copyrights_classCallCheck(this, Copyrights);
...
function checkCardValidity(input) {
  var cardType = '';
  var slice1 = +input.slice(0, 1);
  var slice2 = +input.slice(0, 2);
  var slice3 = +input.slice(0, 3);
  var slice4 = +input.slice(0, 4);
